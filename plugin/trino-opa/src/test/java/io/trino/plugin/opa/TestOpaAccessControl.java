...
public class TestOpaAccessControl
{
    ...
    public void testResponseHasExtraFields()
    {
        ...
        authorizer.checkCanExecuteQuery(requestingSecurityContext);
    }
    ...
    private void testNoResourceActionContext(String actionName, BiConsumer<OpaAccessControl, SystemSecurityContext> method)
    {
        ...
        TestHelpers.ThrowingMethodWrapper wrappedMethod = new TestHelpers.ThrowingMethodWrapper((accessControl) -> method.accept(accessControl, TEST_SECURITY_CONTEXT));
        assertAccessControlMethodBehaviour(wrappedMethod, expectedRequests);
    }
    ...
    public void testFunctionResourceActions()
    {
        ...
        assertAccessControlMethodBehaviour(
                new TestHelpers.ThrowingMethodWrapper(authorizer -> authorizer.checkCanExecuteFunction(TEST_SECURITY_CONTEXT, "my_routine_name")),
                ImmutableSet.of(functionRequest.formatted("ExecuteFunction")));
        assertAccessControlMethodBehaviour(
    ...
    public void testRequestContextContentsWithKnownTrinoVersion()
    {
        testRequestContextContentsForGivenTrinoVersion(
                Optional.of(new TestingSystemAccessControlContext("UNKNOWN")),
                "UNKNOWN");
    }
    ...
    private void testRequestContextContentsForGivenTrinoVersion(Optional<SystemAccessControlFactory.SystemAccessControlContext> accessControlContext, String expectedTrinoVersion)
    {
        ...
        authorizer.checkCanExecuteQuery(TEST_SECURITY_CONTEXT);
